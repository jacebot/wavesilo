...
const REL = `${REPO}/releases/download/v1.1.0`
const BUY_URL = 'https://wavesilo.lemonsqueezy.com/checkout/buy/9435154d-e7a9-4bf0-b4fa-bb4bdb2f4674'

const downloads = [
  { key: 'mac-arm', os: 'macOS', note: 'Apple Silicon', href: `${REL}/Wave.Silo-1.1.0-arm64.dmg` },
  { key: 'mac-intel', os: 'macOS', note: 'Intel', href: `${REL}/Wave.Silo-1.1.0.dmg` },
  { key: 'win', os: 'Windows', note: '.exe installer', href: `${REL}/Wave.Silo.Setup.1.1.0.exe` },
  { key: 'linux', os: 'Linux', note: '.deb · Debian/Ubuntu', href: `${REL}/Wave.Silo-1.1.0.deb` },
]
const ARM_DEB = `${REL}/Wave.Silo-1.1.0-arm64.deb`
      ...
      <main id="top">
        ...
        <section id="download" className="download">
          ...
          <p className="sub center">
            Other Linux distros: <a href={`${REL}/Wave.Silo-1.1.0.tar.gz`}>.tar.gz</a>.
